...
public class ConsultationExamResponse {
    ...
    public ConsultationExamResponse() {
    }

    public ConsultationExamResponse(Long id, Patient patient,
                                    Doctor doctor, Specialty specialty,
                                    LocalDateTime consultationDate, List<DetailConsultationResponse> detailConsultationsResponse,
    ...
    public void setExamResponses(List<ExamResponse> examResponses) {
        this.examResponses = examResponses;
    }
}
